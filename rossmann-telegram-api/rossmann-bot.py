...
def load_dataset( store_id ):
    ...
    df10 = pd.read_csv( '/home/kazu/Repos/Rossman_Sales_Prediction/Data/test.csv' )
    df_store_raw = pd.read_csv( '/home/kazu/Repos/Rossman_Sales_Prediction/Data/store.csv' )
